...
bdl.geodash.VectorEditor = Backbone.View.extend({
	...
	template: _.template(
		...
		'<div class="gd-editor-title">Vector Layer Editor</div> '+
		 '<div class="gd-editor-notice ui-state-error ui-corner-all"><span class="ui-icon ui-icon-alert"></span><span class="gd-notice"></span></div>'+
			...
			'	<label for="name">Shape Names:</label>'+
			'	<div class="gd-editor-item-desc">'+
			'		Enter the names of vector collections to display. Separate collections with a line break.'+
			'	</div><br />'+
			'	<textarea id="ids" name="ids" rows="4" cols="40" ><%= ids %></textarea>'+
			'</div>'+
			'</div>'+
