/**
* options -
*	model - A Mass Marker Layer object
*/
...
bdl.geodash.MassMarkerEditor = Backbone.View.extend({
  ...
  setVisibilityOfcolorOptions: function() {
	...
	template: _.template(
		...
		'<div class="gd-editor-title">Mass Marker Layer Editor</div> '+
     ...
     */
      ...
      ' <div id="size-options">' +
			...
			'		<div class="gd-u first">'+
			'			<label for="minMarkerWidth">Min Width (min: 1): </label>'+
			'		</div>'+
			'		<div class="gd-u">'+
			...
			'		<div class="gd-u first">'+
			'			<label for="maxMarkerWidth">Max Width (max: 255): </label>'+
			'		</div>'+
			'		<div class="gd-u">'+
