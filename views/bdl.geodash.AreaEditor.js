...
bdl.geodash.AreaEditor = Backbone.View.extend({
	...
	save: function(){
		...
		_.each(res,function(i){
			...
			if(k.toLowerCase().indexOf("keys")>-1){
				...
				a[k] = val;
        var silent = true;
        if(k == 'on') { silent = false }
				self.model.set(a,{silent:silent});
			}			
		});
		this.model.validate();
		return this.model;
	...
	template: _.template(
		...
		'<div class="gd-editor-title">Area Layer Editor</div> '+
		 '<div class="gd-editor-notice ui-state-error ui-corner-all"><span class="ui-icon ui-icon-alert"></span><span class="gd-notice"></span></div>'+
			...
			'<div class="gd-section-options">'+
			'	<div class="gd-editor-item-desc">'+
			'		Choose the field containing the name of an area. This could be the name of a state, county, zip code, or custom territories. '+
			'	</div>'+
			'	<div class="gd-ga">'+
			'		<div class="gd-u first">'+
			...
			'<div class="gd-section-options">'+
			'	<div class="gd-editor-item-desc">'+
			'		When using threholds color type, Geodash will use the cell color of the selected field.'+
			'	</div>'+
			'	<div class="gd-ga gd-thresh-metric">	'+
			'		<div class="gd-u first">'+
			'			<label for="keys.colorMetric">Metric: </label>'+
			'		</div>'+
			'		<div class="gd-u">	'+
			...
			'		</div>'+
			'	</div>'+
			'	<div class="gd-g gd-staticColor" style="<% if(colorType == "threshold"){ print("display:none;"); } %>" >'+
			'		<div class="gd-u first">'+
			...
			'	<div class="gd-g">'+
			'		<div class="gd-u first">'+
			'			<label for="strokeColor">Shape Stroke Color: </label>'+
			'		</div>'+
			'		<div class="gd-u">	'+
			'			<div class="colorSelector" id="strokeColorPicker"><div style="background-color: <%= strokeColor %>"></div></div>' +
			'			<input type="hidden" value="<%= strokeColor %>" id="strokeColor" name="strokeColor" />'+
			'		</div>'+
			'	</div>'+
			'	<div class="gd-g">'+
			'		<div class="gd-u first">'+
			...
			'		</div>'+
			'		<div class="gd-u">	'+
			'			<div class="colorSelector" id="highliteColorPicker"><div style="background-color: <%= highliteColor %>"></div></div>' +
			'			<input type="hidden" value="<%= highliteColor %>" id="highliteColor" name="highliteColor" />'+
			'		</div>'+
			'	</div>'+
			'</div>'+
			'</div>'+
			...
			'<div class="gd-section-options">'+
			'	<div class="gd-editor-item-desc">'+
			'		Choose what to display in the info window that appears when an area is clicked on.'+
			'	</div><br/>'+
			'	<div class="gd-radio"> '+
